...
def generate_pipboy_svg(days, streak, rank, survived, invaded, survival_day_count, total_commits):
    ...
    # OUTPUT İSMİNİ GERİ GITHUB'IN BEKLEDİĞİ İSME ÇEVİRDİK (zombi-grafik.svg)
    with open("zombi-grafik.svg", "w", encoding="utf-8") as file:
        file.write(svg_content)
    print(f"[SUCCESS] Canlı (Production) Ana Harita başarıyla oluşturuldu: 'zombi-grafik.svg'")
